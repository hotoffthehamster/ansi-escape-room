...
def compare_with_expected( in_hex, expected ):
    # FIXME: we should resolve expected to a hex value, see the case for #00ff00 giving 46 vs 10
    nearest = HEX( in_hex )
    match = nearest == expected
...
def main():
    ...
    test_set = {
        ...
        # Note the middle one gives '46' which actually has the same
        # color value as '10'
